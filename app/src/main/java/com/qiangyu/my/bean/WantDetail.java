...
public class WantDetail implements Serializable {
    ...
    private String ManagerTeamManager;
    ...
    public void setContractBill(int ContractBill) {
        this.ContractBill = ContractBill;
    }

    public int getContractBill() {
        return ContractBill;
    }
    ...
    public String getManagerTeamManager() {
        return ManagerTeamManager;
    }

    public void setManagerTeamManager(String managerTeamManager) {
        ManagerTeamManager = managerTeamManager;
    }
