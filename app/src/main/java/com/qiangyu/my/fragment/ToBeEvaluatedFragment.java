...
import com.qiangyu.my.adapter.ToBeEvaluatedListAdapter;
...
public class ToBeEvaluatedFragment extends BaseFragment {
    ...
    private ToBeEvaluatedListAdapter mAdapter;
    ...
    private void processDataGoodsToBeReceived(String json) {
        ...
        if (mAdapter == null) {
            ...
            mAdapter = new ToBeEvaluatedListAdapter(mContext, mOrderListResult);
