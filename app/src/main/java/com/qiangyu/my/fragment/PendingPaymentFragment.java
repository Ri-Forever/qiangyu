...
import com.qiangyu.my.adapter.PendingPaymentListAdapter;
...
public class PendingPaymentFragment extends BaseFragment {
    ...
    protected View initView() {
        ...
        startIndex = 1;
        endIndex = pageSize;
        getDataFromPendingPayment(String.valueOf(mMid), "0", String.valueOf(startIndex), String.valueOf(endIndex), mSignInPwd);
    ...
    int pageSize = 30
     */
    void getDataFromPendingPayment(final String mid, final String type, String page, String pageSize, final String signInPwd) {
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        processDataPendingPayment(response);
                    }
                });

    }

    private void processDataPendingPayment(String json) {
        ...
        if (mAdapter == null) {
            ...
            mAdapter = new PendingPaymentListAdapter(mContext, mOrderListResult);
