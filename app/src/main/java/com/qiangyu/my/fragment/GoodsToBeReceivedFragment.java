...
import com.qiangyu.my.adapter.GoodsToBeReceviedListAdapter;
...
public class GoodsToBeReceivedFragment extends BaseFragment {
    ...
    private GoodsToBeReceviedListAdapter mAdapter;
    ...
    protected View initView() {
        ...
        startIndex = 1;
        endIndex = pageSize;
        getDataFromGoodsToBeReceived(String.valueOf(mMid), type, String.valueOf(startIndex), String.valueOf(endIndex), mSignInPwd);
        ...
        mLv_order_list.addFooterView(mInflateFooter);
    ...
    int pageSize = 30
     */
    void getDataFromGoodsToBeReceived(final String mid, final String type, String page, String pageSize, final String signInPwd) {
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        processDataGoodsToBeReceived(response);
                    }
                });

    }

    private void processDataGoodsToBeReceived(String json) {
        ...
        if (mAdapter == null) {
            ...
            mAdapter = new GoodsToBeReceviedListAdapter(mContext, mOrderListResult);
            mLv_order_list.setAdapter(mAdapter);
        } else {
            mSize = mOrderListResult.getOrderList().size();
            mAdapter.onDateChange(mOrderListResult);
        }
        mLv_order_list.removeFooterView(mInflateFooter);
    }
