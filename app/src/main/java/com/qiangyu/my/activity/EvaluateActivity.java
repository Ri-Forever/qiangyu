...
public class EvaluateActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mOrderList = (OrderList) getIntent().getExtras().get("mOrderList");
        initView();
    }
    ...
    private void initView() {
        ...
        mBtn_pingjia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getDataFromCommentOrder(String.valueOf(mid), orderNo, rating, pinglun, "", String.valueOf(i), signInPwd);
            }
        });
    }

    //=================================================发布评价=================================================\\
    void getDataFromCommentOrder(String mid, String orderNo, String rate, String comment, String picstr, String isShow, String signInPwd) {
        ...
        OkHttpUtils
                .post()
                .url(Constants.QIANGYU_URL + "CommentOrder")
                .addParams("mid", mid)
                .addParams("rate", rate)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        processDataCommentOrder(response);
                    }
                });
    }

    private void processDataCommentOrder(String json) {
