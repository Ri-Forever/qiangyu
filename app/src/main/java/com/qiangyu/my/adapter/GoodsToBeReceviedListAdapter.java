...
public class GoodsToBeReceviedListAdapter extends BaseAdapter {
    ...
    public GoodsToBeReceviedListAdapter(Context context, JsonOrderListData.Result orderListResult) {
