...
import com.qiangyu.im.util.AudioRecoderUtils;
import com.qiangyu.im.util.Constants;
import com.qiangyu.im.util.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector name(String name) {
        this.name = name;
        return this;
    }
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EMMessage message = EMMessage.createTxtSendMessage(mEditText.getText().toString(), name);
                ...
                message.setMessageStatusCallback(new EMCallBack() {
                    ...
                    public void onError(int code, String error) {
                        System.out.println("发送失败 code == " + code + "error == " + error.toString());
                        ToastUtil.toastCenter(mActivity, "网络异常,发送失败!");
                    }
                ...
                String time = DateUtil.timeStampDate(message.getMsgTime());
    ...
    public EmotionInputDetector build() {
        ...
        View view = View.inflate(mActivity, R.layout.im_layout_microphone, null);
        ...
        mAudioRecoderUtils.setOnAudioStatusUpdateListener(new AudioRecoderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onStop(long time, String filePath) {
                // TODO: 2018/10/28 0028 语音发送
                //filePath为语音文件路径，length为录音时间(秒)
                int iTime = (int) time;
                EMMessage message = EMMessage.createVoiceSendMessage(filePath, iTime, name);
                //发送语音
                EMClient.getInstance().chatManager().sendMessage(message);
                System.out.println("发送语音");
                mTextView.setText(Utils.long2String(0));
                MessageInfo messageInfo = new MessageInfo();
                String dateTime = DateUtil.timeStampDate(message.getMsgTime());
                messageInfo.setTime(dateTime);
