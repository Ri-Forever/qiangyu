...
import com.qiangyu.im.adapter.EmotionGridViewAdapter;
import com.qiangyu.im.adapter.EmotionPagerAdapter;
import com.qiangyu.im.ui.activity.ContactCustomerServiceActivity;
import com.qiangyu.im.util.EmotionUtils;
import com.qiangyu.im.util.GlobalOnItemClickManagerUtils;
import com.qiangyu.im.util.Utils;
import com.qiangyu.im.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.im_fragment_chat_emotion, container, false);
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = ContactCustomerServiceActivity.screenWidth;
        // item的间距
