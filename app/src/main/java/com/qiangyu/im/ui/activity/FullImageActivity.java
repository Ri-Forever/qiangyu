...
import com.qiangyu.im.enity.FullImageInfo;
...
public class FullImageActivity extends Activity {
    ...
    public void onDataSynEvent(final FullImageInfo fullImageInfo) {
        ...
        //Glide.with(this).load(fullImageInfo.getImageUrl()).diskCacheStrategy(DiskCacheStrategy.ALL).centerCrop().into(fullImage);
    }
