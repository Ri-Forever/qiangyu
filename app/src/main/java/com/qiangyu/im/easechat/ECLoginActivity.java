package com.qiangyu.im.easechat;
...
public class ECLoginActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.im_activity_login_ec);
        ...
        EMClient.getInstance().login(mUsername, mPassword, new EMCallBack() {
            ...
            @Override public void onSuccess() {
                runOnUiThread(new Runnable() {
                    @Override public void run() {
                        mDialog.dismiss();
                        JPushInterface.setAlias(getApplicationContext(),1,mUsername);
                        // 加载所有会话到内存
                        ...
                        Intent intent = new Intent(ECLoginActivity.this, ContactCustomerServiceActivity.class);
